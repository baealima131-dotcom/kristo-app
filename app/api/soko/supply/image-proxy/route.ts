    ...
    const response =
      await fetch(
        current.toString(),
        {
          ...
          headers: {
            Accept:
              "image/jpeg,image/png,image/gif,image/*;q=0.8,*/*;q=0.5",
