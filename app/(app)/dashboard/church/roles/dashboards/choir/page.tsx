// app/(app)/dashboard/church/roles/dashboards/choir/page.tsx
"use client";
...
/**
 * ✅ VIP GOLD Choir Dashboard (DEMO UI)
 * Next steps: connect to API (church members, tasks, attendance, events).
 *
 * ✅ FIX NOTE:
 * Tuna-export component safi `ChoirDashboard` (named) + `Page` (default export)
 * ili router ya [ministryId] iweze ku-import component bila ku-import default page.
 */
...
const DEMO_MEMBERS: ChoirMember[] = [
  { id: "m1", name: "Mama Asha", status: "Active", lastSeen: "Today", voice: "Alto" },
  { id: "m2", name: "Neema Grace", status: "Active", lastSeen: "Yesterday", voice: "Soprano" },
  { id: "m3", name: "John Paul", status: "Inactive", lastSeen: "2 weeks ago", voice: "Tenor" },
  { id: "m4", name: "Peter M.", status: "Active", lastSeen: "Today", voice: "Bass" },
];

const DEMO_TASKS: Task[] = [
  { id: "t1", title: "Pick Sunday song set", status: "InProgress", assignedTo: "Neema Grace" },
  { id: "t2", title: "Rehearsal reminder (WhatsApp)", status: "Open", assignedTo: "Mama Asha" },
  { id: "t3", title: "Prepare lyrics/printouts", status: "Done", assignedTo: "Peter M." },
];
...
export function ChoirDashboard() {
  ...
  const kpis: RoleKpi[] = useMemo(() => {
    ...
    return [
      { label: "Total Choir Members", value: total, hint: "all choir under this ministry" },
    ...
    <div style={wrap}>
      ...
      <div style={topRow}>
        <div>
          <div style={crumbs}>
            ...
            <span style={{ fontWeight: 950 }}>Choir Dashboard</span>
          </div>

          <div style={titleRow}>
            <h1 style={title}>🎶 Choir</h1>
            <span style={vipPill}>VIP • Gold Pure</span>
          </div>

          <div style={sub}>
            Hapa viongozi wa Choir wata-manage waimbaji, rehearsals, tasks, na announcements.
            <div style={{ marginTop: 6, opacity: 0.85 }}>
              Next: tutaunganisha na API ya Church Members + Role Assignments + Events.
            </div>
          </div>
        </div>
      ...
      <div style={grid2}>
        ...
        <section style={card}>
          <div style={cardHead}>
            <div>
              <div style={cardTitle}>Choir Members</div>
                ...
                <div key={m.id} style={row}>
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                    ...
                    <div style={{ opacity: 0.75, fontSize: 12 }}>
                      Last seen: {m.lastSeen || "—"} {m.voice ? `• Voice: ${m.voice}` : ""}
                    </div>
                  </div>
        ...
        <section style={card}>
          <div style={cardHead}>
            <div>
              ...
              <div style={{ opacity: 0.75, fontSize: 12 }}>Weekly execution for choir</div>
            </div>
