...
export default function MoreChurch() {
  ...
  async function executePastorChurchDelete(): Promise<boolean> {
    // Kristo App is free. Subscription ownership/tombstone cleanup is retired.
    await clearChurchLocal();
    return true;
  }

  function onDeleteChurch() {
    // Kristo App is free. No subscription check is required before church deletion.
    confirmDeleteChurch();
  }
          ...
          <View style={s.statusCard}>
            ...
            >
              ...
              <Text style={s.dangerText}>
                {current.role === "Pastor" ? "Delete your church" : "Quit Church"}
              </Text>
            </Pressable>
          </View>
        )}
