...
const AM: GuideContent = {
  ...
  pageSubtitle: "ህጎች • ደህንነት • እገዛ — Kristo App ለአደራጅትችህ እንዴት እንደሰራ።",
  languageLabel: "ቋንቋ",
  updatedLabel: "የመጨረሻ ማዘመን",
  faqTitle: "ተደጋጋሚ ጥያቄዎች",
  sections: [
    {
      id: "about",
      title: "Kristo App ምንድን ነው",
      bullets: [
        "Kristo App ለመገናኛ፣ ሚዲያ፣ ቀጥታ ዝግጅቶች፣ ምስክርነቶች፣ ማስታወሻዎች፣ ማሳወቂያዎች እና የማህበረሰብ ሕይወት የአደራጅት ስርዓት የሆነ መተግበሪያ ነው።",
        "አደራጅቶች Kristo እውነትን ለመጋራት፣ አባላትን ለመገልገል፣ አገልግሎቶችን ለመስተላልፍ እና በመስመር የታመነ መንፈሳዊ ቤት ለመጠበቅ ይጠቀማሉ።",
        "እያንዳንዱ ባህሪ አደራጅቶችን፣ አሳፋሪዎችን፣ አባላትን፣ ትምህርትን እና እምነትን ለመጠበቅ ተዘጋጅቷል።",
      ],
    },
    {
      id: "ai",
      title: "የAI መንፈሳዊ ቪዲዮዎች እና ኦዲዮዎች አይፈቀዱም",
      bullets: [
        "የAI መንፈሳዊ ቪዲዮዎች እና መንፈሳዊ ኦዲዮ በKristo App ውስጥ ለመልእክት፣ ትንቢት፣ አምልኮ፣ ምስክርነት ወይም የአደራጅት ትምህርት አይፈቀዱም።",
        "ይህ AI የተሰሩ መልእክቶች፣ ትንቢቶች፣ የአምልኮ ድምፆች፣ ምስክርነቶች ወይም እውነተኛ አገልግሎት ተብለው የቀረቡ የአሳፋሪ ኦዲዮ/ቪዲዮዎችን ያካትታል።",
        "Kristo App AIን በአጠቃላይ አይቃወምም። AI ከመተግበሪያው ውጭ ወይም ከአደራጅት ትምህርት ውጭ ለሌሎች ስራዎች ሊጠቀም ይችላል።",
        "በKristo App ውስጥ የAI መንፈሳዊ ይዘትን እንገድባለን — አደራጅቶችን፣ አባላትን፣ እውነትን፣ እምነትን እና ትክክለኛ ትምህርትን ለመጠበቅ።",
        "AI መልእክት፣ ትንቢት፣ አምልኮ፣ ምስክርነት ወይም የአደራጅት ትምህርት ካዩት ወዲያውኑ ሪፖርት ያድርጉ።",
      ],
    },
    {
      id: "ownership",
      title: "የአደራጅት ይዘት ባለቤትነት",
      bullets: [
        "አባል በአደራጅት ስር የለጠፈው ልጥፍ የዚያ አደራጅት የማህበረሰብ መዝገብ አካል ይሆናል።",
        "አባሉ ከአደራጅቱ ከወጣ ወይም ከተወገደ፣ የድሮ ልጥፎች ከቁጥጥር ካልተወገዱ በስተቀር የአደራጅቱ ታሪክ ሊሆኑ ይችላሉ።",
        "አሳፋሪዎች እና የታመኑ የሚዲያ ተራዳሚዎች በአደራጅት ፖሊሲ እና በKristo የደህንነት ህጎች መሠረት ይዘቱን ማጣራት፣ መያዝ ወይም ማስወገድ ይችላሉ።",
      ],
    },
    {
      id: "reporting",
      title: "ሪፖርት እና ደህንነት",
      bullets: [
        "የግል ግንኙነት፣ የጥላት ንግግር፣ ማስፈራሪያ፣ መታለል፣ ማስመሰል፣ የሐሰት ተአምራት፣ የሐሰት ትንቢት፣ AI መታለል፣ ጥቃት፣ መጥቀም እና አደገኛ ይዘት ሪፖርት ያድርጉ።",
        "እያንዳንዱ አባል ልጥፍን አንድ ጊዜ ብቻ ሊሪፖርት ይችላል። ሪፖርቶች በMedia Studio → Reports በአሳፋሪ እና በታመኑ የሚዲያ ተራዳሚዎች ይከወናሉ።",
        "ከፍተኛ አደጋ ያላቸው ሪፖርቶች ግምገማ እየተገኘ ጊዜ ቪዲዮን ከህዝብ ፊድ በራስ-ሰር ሊደብቁ ይችላሉ። አሳፋሪዎች ይዘቱን መያዝ ወይም መሰረዝ ይችላሉ።",
        "ሪፖርትን ለቅንና ገባዊ ልዩነት ብቻ ለመደበቅ አትጠቀሙ። False Teaching ሪፖርቶች ከራስ-ሰር መደበቅ በፊት በሰፊው በብዙ አደራጅቶች ስምምነት ይፈልጋሉ።",
      ],
    },
    {
      id: "subscription",
    ...
    {
      id: "media",
      title: "ሚዲያ እና የታመኑ ተራዳሚዎች",
      bullets: [
        "አሳፋሪው የአደራጅት ሚዲያን ያስተዳድራል እና የታመኑ የሚዲያ ተራዳሚዎችን ሊመርጥ ይችላል።",
        "የታመኑ ተራዳሚዎች ሚዲያ ለመስቀል፣ ለመደረደር እና ለመገምገም ይረዳሉ — የአሳፋሪውን ስልጣን ግን አይተኩሉም።",
        "የሚዲያ ሪፖርቶች፣ ማከማቻ እና ቀጥታ መሳሪያዎች ለአሳፋሪው እና ለተፈቀዱ ተራዳሚዎች ይታያሉ።",
      ],
    },
    {
      id: "live",
      title: "የቀጥታ ስርጭት ህጎች",
      bullets: [
        "ቀጥታ መስተላልፎች እውነተኛ የአደራጅት ወይም የአገልግሎት ይዘት መሆን አለባቸው — የሐሰት፣ AI፣ ጥፋተኛ ወይም የሚያስመሱ አይደሉም።",
        "የቅጂ መብት ያለው ቁሳቁስ፣ ማስመሰል፣ መታለል ወይም አባላትን ወደ አደጋ የሚያስገቡ ይዘት አትስተላልፉ።",
        "ቀጥታ መገናኛ ቦታዎች Kristoን፣ አደራጅትችሁን እና ተመልካቾችን መከበር አለባቸው።",
      ],
    },
    {
      id: "conduct",
      title: "አክብሮት ያለው ባህሪ",
      bullets: [
        "መራገም፣ የግል ጥቃት፣ መጥቀም ወይም አሳፋሪዎች/መሪዎች/አባላትን ማግት ውጥይት የለም።",
        "የሐሰት ትምህርትን በሐሳይነት፣ መታለል፣ ወይም አባላትን ለመጋራት፣ ለመከተል ወይም ለቡራኬት ክፍያ ለመጫን አይጠቀሙ።",
        "በጸጋ ተናገሩ። አንድነት፣ ደህንነትና ታማኝነትን ሳያፈራስቱ ልዩነት ሊኖር ይችላል።",
        "ማስታወሻዎችንና ምስክርነቶችን እምነት ለመገንባት ይጠቀሙ — ፍርሃት፣ መከፋፈል ወይም ብዝሃነትን ለማሰርጠት አይደሉም።",
      ],
    },
  ],
  faq: [
    {
      question: "ቪዲዮ ከመስቀል በፊት AI መሳሪያዎችን ለማስተካከል መጠቀም እችላለሁ?",
      answer:
    ...
    },
    {
      ...
      answer:
        "ሪፖርትዎ ወደ አደራጅትዎ Media Studio → Reports ይሄዳል። አሳፋሪዎችና ተራዳሜዎች ይዘቱን መያዝ ወይም መሰረዝ ይችላሉ። ከፍተኛ አደጋ ያላቸው ቅጦች በግምገማ ጊዜ ቪዲዮን ከፊድ ጊዜያዊ ሊደብቁ ይችላሉ።",
    },
    {
      question: "ከአደራጅቱ ሲለቅ የድሮ ልጥፎችዎ ይጠፋሉ?",
      answer:
        "በአደራጅት ስር የተጋሩት ልጥፎች አመራር ወይም መቆጣጠሪያ ካልሰረዛቸው በስተቀር የአደራጅቱ ታሪክ ክፍል ሊሆኑ ይችላሉ።",
    },
    {
      question: "አባላት የአደራጅት ሚዲያ ሊያስተዳድሩ ይችላሉ?",
      answer:
        "አሳፋሪው እና በአሳፋሪው የተሾሙ ተራዳሜዎች ብቻ Media Studio መሳሪያዎች፣ ተራዳሜዎች እና ሪፖርት ግምገማን ያስተዳድራሉ።",
    },
    {
      question: "Kristo ቴክኖሎጂን ወይም AIን ይቃወማል?",
      answer:
        "አይ። Kristo በመተግበሪያው AI የተፈጠረ መንፈሳዊ ይዘትን ይገድባል ትምህርትንና ታማኝነትን ለመጠበቅ። AI በኃላፊነት ከመተግበሪያው ውጭ ወይም ከትምህርት ውጭ ስራዎች ላይ ጥቅም ላይ ሊውል ይችላል።",
    },
  ],
};
