/**
 * Minimal HMAC-SHA256 for iOS V1 free proof minting (no extra native deps).
 * Server verifies with Node crypto.createHmac — keep message format in sync.
 */
...
function sha256(bytes: Uint8Array): Uint8Array {
  ...
  view.setUint32(withPad.length - 8, bitLenHi);
  view.setUint32(withPad.length - 4, bitLenLo);
